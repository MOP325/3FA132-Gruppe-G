...
// // Verify that the insert method of UserDAO is called with the correct
// parameters
// verify(userDAO, times(1)).insert("Jeremy", "Rentschler", "123",
// "12344442323242");
// }
...
// void testUpdateUser() {
// int userId = 1;
// User updatedUser = new User(userId, "Updated", "User", "newPassword",
// "newToken");

// userResource.updateUser(userId, updatedUser);

// // Verify that the update method of UserDAO is called with the correct
// parameters
// verify(userDAO, times(1)).update(userId, "Updated", "User", "newPassword",
// "newToken");
// }
...
// // Verify that the findById method of UserDAO is called with the correct
// parameter
...
// // Verify that the delete method of UserDAO is called with the correct
// parameter
